...
namespace AIGame
{
    ...
    public class BasicPrimitives
    {
        ...
        public BasicPrimitives(GraphicsDevice _graphicsDevice)
        {
            ...
            // NOTE: migration to XNA 4.0 m_Pixel = new Texture2D(_graphicsDevice, 1, 1, 1, TextureUsage.None, SurfaceFormat.Color);
            m_Pixel = new Texture2D(_graphicsDevice, 1, 1, true, SurfaceFormat.Color);
